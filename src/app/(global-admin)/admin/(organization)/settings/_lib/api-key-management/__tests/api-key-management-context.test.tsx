...
} from "@/app/(global-admin)/admin/(organization)/settings/_lib/api-key-management/context/api-key-management-context";
...
vi.mock(
    "@/app/(global-admin)/admin/(organization)/settings/_lib/api-key-management/hooks/use-api-key-actions"
);
