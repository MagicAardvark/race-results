...
import { ClassGroupsManagement } from "../components/class-groups-management";
import type { ClassGroupWithClasses } from "@/dto/class-groups";
import type { AvailableBaseClass } from "../types";

vi.mock("../components/class-groups-list", () => ({
    ClassGroupsList: ({
        classGroups,
    }: {
...
vi.mock("../components/create-class-group-dialog", () => ({
...
describe("ClassGroupsManagement", () => {
    ...
    it("renders create button", () => {
        ...
        expect(
            screen.getByRole("button", { name: /Add Class Group/i })
        ).toBeVisible();
    });
