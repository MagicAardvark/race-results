import { createIndexValue } from "@/app/(global-admin)/admin/(global)/classes/_lib/actions/create-index-value";
import { addIndexValueSchema } from "@/app/(global-admin)/admin/(global)/classes/_lib/schema";
import {
    Form,
    FormError,
    FormInput,
